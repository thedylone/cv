...
\begin{subsections}
    ...
    \begin{itemize}
        \item Courses: Stochastic Optimisation, High Performance Scientific Computing, Algorithms
    \end{itemize}

    \DatedSubsection{Imperial College London}{Oct 2022 -- Jun 2025}
    \subtitle{BEng Mechanical Engineering -- First Class Honours, 1$^{st}$ overall \hfill London, United Kingdom}
    \begin{itemize}
        \item Governors' BEng Prize for Top Scorer Overall
...
\begin{subsections}
    \DatedEntry{Governors' BEng Prize in Mechanical Engineering: Top Student Overall}{2025}
