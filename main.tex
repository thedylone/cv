...
\begin{minipage}[h]{.33\textwidth-0.33\margin}
    \begin{itemize}
        ...
        \item[\Large\faAt] \href{mailto:thedylone@gmail.com}{thedylone@gmail.com}
...
\begin{subsections}
    ...
    -- Expected GPA: 3.92 / 4.0
        \hfill Massachusetts, United States}
    \begin{itemize}
        \item Courses: \parbox[t]{\dimexpr\linewidth-\labelwidth-\labelsep\relax-2em}{Design \& Analysis of Algorithms, 
        High Performance Computing \& Big Data Systems \textit{(Parallel, Distributed, GPU CUDA)}, 
        Stochastic Methods \& Decision Theory \textit{(Regression, Optimisation, Bayesian Inference)}}
        \vspace{0.01em}
        \item Extra-curricular: MIT Puzzle Club
    \end{itemize}
    ...
    \begin{itemize}[leftmargin=!, itemindent=-1em]
        \item \hyperlink{award_BEng}{Governors' BEng Prize for Top Scorer Overall}
        \item Modules: Mechatronics \& Machine Dynamics, Mathematics, Computing, Thermofluids, Solid Mechanics
        \item Dean's List, Top Scorer in Professional Engineering Skills, \hyperlink{proj_DMT}{Best Superproject in Design Make and Test Project}
...
\begin{subsections}
    ...
    \begin{itemize}[leftmargin=!, itemindent=-1em]
        \item Revamped software architecture in \href{https://www.mathworks.com/products/autosar.html}{AUTOSAR Blockset}, a toolbox for developing AUTOSAR software
        \item Accelerated software performance up to 90\% faster, with the capacity to significantly speed up customer workflows
    ...
    \begin{itemize}[leftmargin=!, itemindent=-1em]
        \item Developed a \href{https://github.com/thedylone/tile-segmentation-pipeline}{novel ML 3D segmentation pipeline} for 3D Tiles to be used in simulations and data analyses
        \item Implemented semantic segmentation with a Transformer to label a 2D texture to 3D vertex UV mapping
...
\section{Projects}
\begin{subsections}
    \DatedSubsection{Full Stack \& Cloud Deployed Organisational AI Dashboard}{Feb 2026}
    \subtitle{\href{https://superintelligent-staff.fly.dev/}{https://superintelligent-staff.fly.dev/} \hfill Massachusetts, United States}
    \begin{itemize}[leftmargin=!, itemindent=-1em]
        \item RAG-architecture LLM-integrated dashboard for automated information extraction into actionable items
        \item \textbf{Skills}: RAG, Graph Databases, React, NodeJS, System integration
    \end{itemize}

    \hypertarget{proj_DMT}{}\DatedSubsection{Haptic Radio Controller for a Rotating Performing Arts Stage}{Oct 2024 -- Jun 2025}
    \subtitle{MECH60003 - Design, Make and Test Project \hfill Imperial College London, United Kingdom}
    \begin{itemize}[leftmargin=!, itemindent=-1em]
        \item Designed hardware and electronics, programmed a Teensy 4.1 Microcontroller for sonsors and radio comms
        \item \textbf{Skills}: Embedded C, C++, CAD, Electrical engineering, Teamwork, System integration
    \end{itemize}
    ...
    \Subsection{Cloud Deployed Game Tracker Discord Bot with Continuous Deployment}
    ...
    \Subsection{Full Stack Video Player Server and Webpage}
    \begin{itemize}[leftmargin=!, itemindent=-1em]
...
\begin{subsections}
    ...
    \item \textbf{Interests:} Puzzles \& puzzlehunts (\href{https://puzzles.mit.edu/}{MIT Mystery Hunts}), Cooking, Baseball, Football (aka soccer)
\end{subsections}
